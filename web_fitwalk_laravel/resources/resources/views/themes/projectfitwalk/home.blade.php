    ...
    <div class="row mt-5">
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          <a href="#"><img src="{{ asset('themes/projectfitwalk/assets/img/shop_01.jpg') }}" alt="" class="img-fluid"></a>
      ...
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          <a href="#"><img src="{{ asset('themes/projectfitwalk/assets/img/shop_02.jpg') }}" alt="" class="img-fluid"></a>
      ...
      <div class="col-lg-3 col-6 mt-3 mt-lg-0">
        <div class="card card-body p-lg-4 p3">
          <a href="#"><img src="{{ asset('themes/projectfitwalk/assets/img/shop_03.jpg') }}" alt="" class="img-fluid"></a>
      ...
      <div class="col-lg-3 col-6 mt-3 mt-lg-0">
        <div class="card card-body p-lg-4 p3">
          <a href="#"><img src="{{ asset('themes/projectfitwalk/assets/img/shop_04.jpg') }}" alt="" class="img-fluid"></a>
